                        ...
                        @if(isset($departamentos))
                            <form action="{{ route('admin.asignaturas.store') }}" method="post">
                                ...
                                <div class="input-group mb-3">
                                    <input class="form-control @error('nombre') border-danger @enderror" type="text" name="nombre" id="nombre" placeholder="Nombre de la Asignatura" value="{{ old('nombre') }}">
                                </div>
                                @error('nombre')
                                ...
                                <div class="input-group mb-4 row mx-auto">
                                    <select class="form-control @error('depto') border-danger @enderror" name="depto" id="depto">
                                ...
                                <div class="col-6">
                                    <div class="row">
                                        <button class="btn btn-primary px-4" type="submit">Crear Asignatura</button>
                                    </div>
                                </div>
                            </form>
                        @endif
